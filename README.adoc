...
.. Apply `ServiceMeshPeer` & `ExportedServiceSet`
+
-----
...
.. Apply `ServiceMeshPeer` & `ImportedServiceSet`
+
-----
...
+
-----
$ oc apply -f east/mesh-fed/east2/servicemeshpeers.yml
$ oc apply -f east/mesh-fed/east2/importedserviceset-failover.yml
-----
...
$ oc delete -k west/mesh-fed --ignore-not-found=true \
    && oc delete cm --all -n west-istio-mesh \
